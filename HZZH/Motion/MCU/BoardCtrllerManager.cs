...
namespace Device
{
    public class BoardCtrllerManager
    {
        ...
        /// 轴当前位置
        /// </summary>
        public BaseData CurrentPos = new BaseData(100, 50, DataType.Float);
        /// <summary>
        /// 轴当前状态
        /// </summary>
        ...
        /// 输入口
        /// </summary>
        public BaseData InputStatus = new BaseData(310, 40); 
        /// <summary>
        /// 报警码
        /// </summary>
        ...
        /// 输出口
        /// </summary>
        public BaseData OutputStatus = new BaseData(1020, 40);
